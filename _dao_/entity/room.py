...
class Room:
    ...
    def room_id(self) -> Union[Callable[[], int], Callable[[int], None]]:
        return self.room_id
    ...
    def max_capacity(self) -> Union[Callable[[], int], Callable[[int], None]]:
        return self.max_capacity

    def max_capacity(self, val: int):
        self._max_capacity = val

    def room_prise(self) -> Union[Callable[[], int], Callable[[int], None]]:
